...
/// @nodoc
mixin _$UploadGitImageModel {

 String get fileName; String get base64Content; String get commitMessage; String? get sha;
/// Create a copy of UploadGitImageModel
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$UploadGitImageModelCopyWith<UploadGitImageModel> get copyWith => _$UploadGitImageModelCopyWithImpl<UploadGitImageModel>(this as UploadGitImageModel, _$identity);

  /// Serializes this UploadGitImageModel to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UploadGitImageModel&&(identical(other.fileName, fileName) || other.fileName == fileName)&&(identical(other.base64Content, base64Content) || other.base64Content == base64Content)&&(identical(other.commitMessage, commitMessage) || other.commitMessage == commitMessage)&&(identical(other.sha, sha) || other.sha == sha));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,fileName,base64Content,commitMessage,sha);

@override
String toString() {
  return 'UploadGitImageModel(fileName: $fileName, base64Content: $base64Content, commitMessage: $commitMessage, sha: $sha)';
}
...
/// @nodoc
abstract mixin class $UploadGitImageModelCopyWith<$Res>  {
  factory $UploadGitImageModelCopyWith(UploadGitImageModel value, $Res Function(UploadGitImageModel) _then) = _$UploadGitImageModelCopyWithImpl;
@useResult
$Res call({
 String fileName, String base64Content, String commitMessage, String? sha
});
...
/// @nodoc
class _$UploadGitImageModelCopyWithImpl<$Res>
    implements $UploadGitImageModelCopyWith<$Res> {
  _$UploadGitImageModelCopyWithImpl(this._self, this._then);

  final UploadGitImageModel _self;
  final $Res Function(UploadGitImageModel) _then;

/// Create a copy of UploadGitImageModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? fileName = null,Object? base64Content = null,Object? commitMessage = null,Object? sha = freezed,}) {
  return _then(_self.copyWith(
fileName: null == fileName ? _self.fileName : fileName // ignore: cast_nullable_to_non_nullable
as String,base64Content: null == base64Content ? _self.base64Content : base64Content // ignore: cast_nullable_to_non_nullable
...
/// Adds pattern-matching-related methods to [UploadGitImageModel].
extension UploadGitImageModelPatterns on UploadGitImageModel {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _UploadGitImageModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _UploadGitImageModel() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _UploadGitImageModel value)  $default,){
final _that = this;
switch (_that) {
case _UploadGitImageModel():
return $default(_that);}
}
/// A variant of `map` that fallback to returning `null`.
///
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _UploadGitImageModel value)?  $default,){
final _that = this;
switch (_that) {
case _UploadGitImageModel() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String fileName,  String base64Content,  String commitMessage,  String? sha)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UploadGitImageModel() when $default != null:
return $default(_that.fileName,_that.base64Content,_that.commitMessage,_that.sha);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String fileName,  String base64Content,  String commitMessage,  String? sha)  $default,) {final _that = this;
switch (_that) {
case _UploadGitImageModel():
return $default(_that.fileName,_that.base64Content,_that.commitMessage,_that.sha);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String fileName,  String base64Content,  String commitMessage,  String? sha)?  $default,) {final _that = this;
switch (_that) {
case _UploadGitImageModel() when $default != null:
return $default(_that.fileName,_that.base64Content,_that.commitMessage,_that.sha);case _:
  return null;
...
class _UploadGitImageModel implements UploadGitImageModel {
  const _UploadGitImageModel({required this.fileName, required this.base64Content, required this.commitMessage, this.sha});
  factory _UploadGitImageModel.fromJson(Map<String, dynamic> json) => _$UploadGitImageModelFromJson(json);

@override final  String fileName;
@override final  String base64Content;
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$UploadGitImageModelCopyWith<_UploadGitImageModel> get copyWith => __$UploadGitImageModelCopyWithImpl<_UploadGitImageModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$UploadGitImageModelToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UploadGitImageModel&&(identical(other.fileName, fileName) || other.fileName == fileName)&&(identical(other.base64Content, base64Content) || other.base64Content == base64Content)&&(identical(other.commitMessage, commitMessage) || other.commitMessage == commitMessage)&&(identical(other.sha, sha) || other.sha == sha));
}
...
/// @nodoc
abstract mixin class _$UploadGitImageModelCopyWith<$Res> implements $UploadGitImageModelCopyWith<$Res> {
  factory _$UploadGitImageModelCopyWith(_UploadGitImageModel value, $Res Function(_UploadGitImageModel) _then) = __$UploadGitImageModelCopyWithImpl;
@override @useResult
$Res call({
 String fileName, String base64Content, String commitMessage, String? sha
});
...
/// @nodoc
class __$UploadGitImageModelCopyWithImpl<$Res>
    implements _$UploadGitImageModelCopyWith<$Res> {
  __$UploadGitImageModelCopyWithImpl(this._self, this._then);

  final _UploadGitImageModel _self;
  final $Res Function(_UploadGitImageModel) _then;

/// Create a copy of UploadGitImageModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? fileName = null,Object? base64Content = null,Object? commitMessage = null,Object? sha = freezed,}) {
  return _then(_UploadGitImageModel(
fileName: null == fileName ? _self.fileName : fileName // ignore: cast_nullable_to_non_nullable
as String,base64Content: null == base64Content ? _self.base64Content : base64Content // ignore: cast_nullable_to_non_nullable
as String,commitMessage: null == commitMessage ? _self.commitMessage : commitMessage // ignore: cast_nullable_to_non_nullable
as String,sha: freezed == sha ? _self.sha : sha // ignore: cast_nullable_to_non_nullable
